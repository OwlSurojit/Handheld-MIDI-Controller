...
class ControllerListWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        setup_hint = self.setup_wizard_button.sizeHint()
        setup_min_height = max(setup_hint.height() + 8, self.fontMetrics().height() + 16)
        setup_min_width = max(setup_hint.width() + 24, self.fontMetrics().horizontalAdvance("Set Up Controllers...") + 40)
        self.setup_wizard_button.setMinimumHeight(setup_min_height)
        self.setup_wizard_button.setMinimumWidth(setup_min_width)
    ...
    def _open_context_menu(self, pos):
        ...
        title_label.setContentsMargins(12, 4, 12, 4)
